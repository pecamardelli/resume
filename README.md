...
### <a href="https://pecamardelli.github.io/my-resume/">LIVE DEMO</a>
...
### You can clone this repo and simply modify the JSON files with your resume data and/or language data, or you can follow the steps below to create one from scratch.
